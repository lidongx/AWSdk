...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FpgSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC6FpgSdk8AdConfig")
...
SWIFT_PROTOCOL("_TtP6FpgSdk10AdDelegate_")
@protocol AdDelegate <NSObject>
@optional
- (void)adLoadSuccessWithAd:(id _Nonnull)ad;
- (void)adLoadFailedErrorWithAd:(id _Nonnull)ad error:(GADRequestError * _Nullable)error;
- (void)adWillAppearWithAd:(id _Nonnull)ad;
- (void)adDidAppearWithAd:(id _Nonnull)ad;
- (void)adWillDisAppearWithAd:(id _Nonnull)ad;
- (void)adDidDisAppearWithAd:(id _Nonnull)ad;
- (void)adShowFailWithAd:(id _Nonnull)ad;
- (void)adClickLeaveAppWithAd:(id _Nonnull)ad;
- (void)adEarnWithRewardedAd:(GADRewardedAd * _Nonnull)rewardedAd userDidEarn:(GADAdReward * _Nonnull)reward;
@end


SWIFT_CLASS("_TtC6FpgSdk5AdMgr")
...
SWIFT_CLASS("_TtC6FpgSdk6AdUtil")
...
SWIFT_CLASS("_TtC6FpgSdk9BannerMgr")
@interface BannerMgr : NSObject <GADBannerViewDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC6FpgSdk11FirebaseMgr")
@interface FirebaseMgr : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC6FpgSdk6FpgSdk")
@interface FpgSdk : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC6FpgSdk15InterstitialMgr")
@interface InterstitialMgr : NSObject <GADInterstitialDelegate>
...
SWIFT_CLASS("_TtC6FpgSdk7RectMgr")
@interface RectMgr : BannerMgr
@end


SWIFT_CLASS("_TtC6FpgSdk9RewardMgr")
@interface RewardMgr : NSObject <GADRewardedAdDelegate>
