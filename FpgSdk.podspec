#
#  Be sure to run `pod spec lint FpgSdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "FpgSdk"
  spec.version      = "2.0.1"
  spec.summary      = "A short description of FpgSdk."
  ...
  spec.homepage     = "http://EXAMPLE/FpgSdk"
  ...
  #spec.source_files  = "FpgSdk", "FpgSdk/**/*.{h,m}"
  #spec.exclude_files = "Classes/Exclude"

spec.ios.vendored_frameworks = "FpgSdk.framework"
...
spec.static_framework = true
  ...
  #  you can include multiple dependencies to ensure it works.
   ...
   spec.dependency 'Firebase', '6.5.0'
